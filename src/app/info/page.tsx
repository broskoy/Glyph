  ...
  return (
    <div style={{ padding: "4rem 2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <div style={{ marginTop: "2rem" }}>
        <h2 style={{ fontSize: "1.6rem", marginBottom: "0.2rem", opacity: 0.9 }}>Our Mission</h2>
        ...
        <h2 style={{ fontSize: "1.6rem", marginBottom: "0.2rem", opacity: 0.9 }}>Membership</h2>
        <p style={{ color: "var(--text-secondary)", marginBottom: "3.5rem", fontSize: "1.2rem" }}>
        ...
        <h2 style={{ fontSize: "1.6rem", marginBottom: "0.2rem", opacity: 0.9 }}>Events & Exhibitions</h2>
        <p style={{ color: "var(--text-secondary)", marginBottom: "3.5rem", fontSize: "1.2rem" }}>
